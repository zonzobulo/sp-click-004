...
// const links = hero.querySelectorAll(`.link-item[data-place="${placeIndex}']`).classList.add('active')
...
function showPlace() {
  ...
  hero.querySelectorAll(`.link-item[data-place="${placeIndex}"]`).classList.add('active')
